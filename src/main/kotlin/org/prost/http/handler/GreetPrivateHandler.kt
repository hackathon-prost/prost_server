...
private val logger = LoggerFactory.getLogger(GreetPrivateHandler::class.java)

private const val PATH = "/kotlin-template/greet-private/:lang"

class GreetPrivateHandler(private val greet: Greet) : Handler {
