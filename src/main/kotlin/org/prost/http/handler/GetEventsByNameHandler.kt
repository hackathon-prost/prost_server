...
import org.prost.core.action.GetEventsByName
...
private const val PATH = "/prost/api/events/name/:name"

private const val NAME = "name"

class GetEventsByNameHandler(private val getEventsByName: GetEventsByName) : Handler {
